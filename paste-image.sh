...
echo "  $SNIPPET"
echo ""
echo "To caption it, add a quoted title after the URL:"
echo "  ![](/$DEST \"Your caption.\")"
echo ""
...
echo ""
echo "Those need a figure if they're also captioned:"
echo "  <figure><img class=\"torn\" src=\"/$DEST\" alt=\"\">"
echo "  <figcaption>Your caption.</figcaption></figure>"
